package club.minemen.spigot.protocol;
...
public class MinecraftPipeline extends ChannelInitializer<SocketChannel> {
	...
	protected void initChannel(SocketChannel channel) {
		try {
			...
			config.setOption(ChannelOption.TCP_NODELAY, ClubSpigotConfig.enableTCPNODELAY);
			config.setOption(ChannelOption.TCP_FASTOPEN, ClubSpigotConfig.modeTcpFastOpen);
			config.setOption(ChannelOption.TCP_FASTOPEN_CONNECT,ClubSpigotConfig.enableTcpFastOpen);
