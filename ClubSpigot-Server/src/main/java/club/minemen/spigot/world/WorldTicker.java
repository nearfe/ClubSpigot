package club.minemen.spigot.world;
...
import club.minemen.spigot.async.ResettableLatch;
...
public class WorldTicker implements Runnable {
	...
	private final ResettableLatch latch = new ResettableLatch(ClubSpigotConfig.trackingThreads);
	...
	@Override
	public void run() {
		run((!ClubSpigotConfig.disableTracking && ClubSpigotConfig.fullAsyncTracking));
	}
