package club.minemen.spigot.async.pathsearch;
...
import club.minemen.spigot.async.pathsearch.cache.SearchCacheEntryEntity;
import club.minemen.spigot.async.pathsearch.cache.SearchCacheEntryPosition;
...
public class SearchHandler {
	...
	private final ExecutorService executor = Executors.newFixedThreadPool(ClubSpigotConfig.pathSearchThreads,
			new ThreadFactoryBuilder().setNameFormat("ClubSpigot Entity Path Search Thread %d").build());
