...
package club.minemen.spigot.async.thread;
...
import club.minemen.spigot.async.netty.Spigot404Write;
...
public abstract class AsyncPacketThread {
	...
	private static final int TPS = ClubSpigotConfig.combatThreadTPS;
