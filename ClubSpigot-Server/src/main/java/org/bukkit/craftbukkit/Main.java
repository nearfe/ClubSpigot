		...
		OptionParser parser = new OptionParser() {
			{
				...
				acceptsAll(asList("clubspigot", "clubspigot-settings"), "File for clubspigot settings").withRequiredArg()
				.ofType(File.class).defaultsTo(new File("clubspigot.yml")).describedAs("Yml file");
				// ClubSpigot end
			}
		};
