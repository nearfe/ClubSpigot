...
import club.minemen.spigot.commons.ConcurrentIntHashMap;
...
public class EntityTracker {
	...
	public IntHashMap<EntityTrackerEntry> trackedEntities = new ConcurrentIntHashMap<>(); // ClubSpigot

	private volatile int noTrackDistance = 0; // ClubSpigot - volatile
	...
	// IonSpigot start
	protected EntityTrackerEntry createTracker(Entity entity, int i, int j, boolean flag) { // ClubSpigot - protected
		if (entity.isCannoningEntity && ClubSpigotConfig.useFasterCannonTracker) {
