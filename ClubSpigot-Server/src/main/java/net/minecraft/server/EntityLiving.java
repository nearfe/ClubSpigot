...
public abstract class EntityLiving extends Entity {
	...
	public EntityLiving(World world) {
		...
		this.k = true;
		// ClubSpigot start - use faster randoms
	...
	public void a(Entity opponent, double x, double z, DamageSource source) {
		if (this.random.nextDouble() >= this.getAttributeInstance(GenericAttributes.c).getValue()) {
			...
			double value = kb.getVerticalLimitValue();
			if (kb.isVerticalLimit() && this.motY > value) {
				this.motY = value;
			}
		}
	}
	...
	public void m() {
		...
		// ClubSpigot start - smoother mob AI disable
	...
	public boolean hasLineOfSightAccurate(Entity entity) {
		...
		if (entity instanceof EntityPlayer && ClubSpigotConfig.improvedHitDetection) {
