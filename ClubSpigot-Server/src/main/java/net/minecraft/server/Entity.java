...
public abstract class Entity implements ICommandListener {
	...
	public boolean invulnerable; // ClubSpigot - private -> public
	...
	public double c(BlockPosition blockposition) {
		...
		// ClubSpigot - reduce usage of block position
		return distanceSquared(blockposition.getX(), blockposition.getY(), blockposition.getZ());
	}
	
	// ClubSpigot start - reduce usage of blockposition
	...
	public double distanceSqrdAccurate(Entity entity) {
		...
		if (ClubSpigotConfig.improvedHitDetection && entity instanceof EntityPlayer && this instanceof EntityPlayer) {
			...
			if (entityPlayer.playerConnection.getClass().equals(PlayerConnection.class)
				...
				loc = ClubSpigot.getInstance().getLagCompensator().getHistoryLocation(entityPlayer.getBukkitEntity(),
						player.ping);
			} else {
