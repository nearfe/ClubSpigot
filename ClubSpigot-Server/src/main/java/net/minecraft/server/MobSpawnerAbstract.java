...
import club.minemen.spigot.cache.Constants;
...
public abstract class MobSpawnerAbstract {
	...
	public MobSpawnerAbstract() {
		// ClubSpigot start - configurable spawner settings
		this.spawnDelay = ClubSpigotConfig.spawnersInitialSpawnDelay;
		this.minSpawnDelay = ClubSpigotConfig.spawnersMinSpawnDelay;
		this.maxSpawnDelay = ClubSpigotConfig.spawnersMaxSpawnDelay;
		this.spawnCount = ClubSpigotConfig.spawnersSpawnCount;
		this.spawnRange = ClubSpigotConfig.spawnersSpawnRange;
		this.maxNearbyEntities = ClubSpigotConfig.spawnersMaxNearbyEntities;
		this.requiredPlayerRange = ClubSpigotConfig.spawnersRequiredPlayerRange;
		// ClubSpigot end
	}
	...
	public void c() {
		...
		if (this.g()) {
			...
			if (this.a().isClientSide) {
				...
				// ClubSpigot start - configurable spawner animations
				if (ClubSpigotConfig.spawnerAnimation) {
