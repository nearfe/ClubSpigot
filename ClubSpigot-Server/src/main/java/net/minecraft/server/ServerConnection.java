...
import club.minemen.spigot.protocol.MinecraftPipeline;
...
public class ServerConnection {
	...
	public void a(InetAddress ip, int port) throws IOException {
		synchronized (this.getListeningChannels()) {
			...
			LOGGER.info("ClubSpigot: Using " + Natives.compress.getLoadedVariant() + " compression from Velocity.");
			LOGGER.info("ClubSpigot: Using " + Natives.cipher.getLoadedVariant() + " cipher from Velocity.");
			// Paper end
