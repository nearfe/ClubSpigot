...
public class Explosion {
			...
			if (!entity.aW()) {
				if (!entity.dead) {
					...
					if (distanceSquared <= 64.0D && distanceSquared != 0.0D) {
						...
						// ClubSpigot start - toggleable async explosions
	...
	public void a(boolean flag) {
		...
		// ClubSpigot start - configurable explosion sounds
		if (ClubSpigotConfig.explosionSounds) {
		...
		// ClubSpigot start - configurable explosion animations
		if (ClubSpigotConfig.explosionAnimation) {
		...
		if (this.b) {
			...
			if (explode != null) {
				...
				if (ClubSpigotConfig.fireEntityExplodeEvent) {
